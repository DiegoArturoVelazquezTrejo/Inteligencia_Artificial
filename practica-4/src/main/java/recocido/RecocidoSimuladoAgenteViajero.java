...
public class RecocidoSimuladoAgenteViajero extends RecocidoSimulado{
    /**
	 ...
	 */
	public RecocidoSimuladoAgenteViajero(Solucion inicial,float temperaturaInicial,float decaimiento, int ejecuciones){ //escoge los parametros necesarios para inicializar el algoritmo
